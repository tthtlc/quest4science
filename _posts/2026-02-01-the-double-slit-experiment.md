...
**Focus:**
When a beam passes through two slits, the waves interfere and create bright and dark bands. Single photons fired one by one still build the same pattern over time.
